    ...
    implements Dictionary<K,V>, Iterable<V>
{
  ...
  /**
   * The number of changes we've made to the hash table (used for
   * "fail fast" iterators).
   */
  long updates = 0;
  ...
  /**
   * Remove the key/value pair at a particular index.
   */
  ...
  /**
   * Get an iterator for the key/value pairs (the generic version of
   * the other two iterators.
   */
  Iterator<KVPair> pairIterator()
  {
    return new Iterator<KVPair>()
      {
        ...
        /**
         * The next position in the array to look in.
         */
        int pos = 0;

        /**
         * The number of elements we've looked at.
         */
        int iterated = 0;
         ...
         */
        long updates = OpenHashTable.this.updates;

        /**
         * Did we just visit a key/value pair?
         */
        ...
        {
          if (this.updates != OpenHashTable.this.updates)
        ...
        public boolean hasNext()
        {
          ...
          return this.iterated < OpenHashTable.this.size;
        } // hasNext()

        public KVPair next()
          throws NoSuchElementException
        {
          // Sanity check (also does the failFast)
          if (!this.hasNext())
            throw new NoSuchElementException();
          // Advance until we find a useful cell
          while (OpenHashTable.this.pairs[this.pos++] == null)
            ;
          // Note that we've looked at another value.
          ++this.iterated;
          this.visited = true;
          // Return the value found
          return OpenHashTable.this.get(this.pos-1);
        } // next()
        ...
        public void remove()
        {
          ...
          // Remove using the underlying strategy
          OpenHashTable.this.removeAt(this.pos-1);
          this.updates = OpenHashTable.this.updates;
        } // remove()
      }; // new Iterator<KVPair>
  } // pairIterator
  ...
  public Iterator<V> iterator()
  {
    return new Iterator<V>()
      {
        /**
         * The underlying pair iterator.
         */
        Iterator<KVPair> base = pairIterator();
